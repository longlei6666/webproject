	...
	<body>
		<div class="x-body">
			<form class="layui-form">
				<input type="hidden" id="picAddress" name="picAddress" required="" lay-verify="required" autocomplete="off" class="layui-input">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="latitude" name="latitude" required="" class="layui-input">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="tphone" name="tphone" required="" lay-verify="tphone" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item layui-form-text">
					<label class="layui-form-label">备注1</label>
					<div class="layui-input-inline" style="width: calc(100% - 150px);">
						<textarea id="remarkOne" name="remarkOne" placeholder="请输入内容" class="layui-textarea"></textarea>
					</div>
				</div>
				<div class="layui-form-item layui-form-text">
					<label class="layui-form-label">备注2</label>
					<div class="layui-input-inline" style="width: calc(100% - 150px);">
						<textarea id="remarkTwo" name="remarkTwo" placeholder="请输入内容" class="layui-textarea"></textarea>
					</div>
				</div>
				<div class="layui-form-item">
