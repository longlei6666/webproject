...
<html>
	...
	<head>
		...
		<!-- 图片上传即使预览插件 -->
		<link rel="stylesheet" href="${pageContext.request.contextPath }/configuration/bootstarpfileinput/css/fileinput.min.css">
		<script type="text/javascript" src="${pageContext.request.contextPath }/configuration/bootstarpfileinput/js/fileinput.min.js"></script>
		<!-- 这个是汉化-->
		<script type="text/javascript" src="${pageContext.request.contextPath }/configuration/bootstarpfileinput/zh.js"></script>
	...
	<body>
		<div class="x-body">
			<form class="layui-form">
				<input type="hidden" id="picAddress" name="picAddress" required="" autocomplete="off" class="layui-input">
				<input type="hidden" value="${shop.shopNumber }" id="shopNumber" name="shopNumber" required="" lay-verify="required" autocomplete="off" class="layui-input">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<select name="province" id="province" lay-ignore>
							<option value="">${shop.province}</option>
						</select>
					</div>
					<div class="layui-input-inline">
						<select name="city" id="city" lay-ignore>
							<option value="">${shop.city}</option>
						</select>
					</div>
					<div class="layui-input-inline">
						<select name="area" id="area" lay-ignore>
							<option value="">${shop.area}</option>
						</select>
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input value="${shop.longitude}" type="text" id="longitude" name="longitude" required="" class="layui-input">
					</div>
					<label for="phone" class="layui-form-label">
                  	纬度
              		</label>
					<div class="layui-input-inline">
						<input value="${shop.latitude}" type="text" id="latitude" name="latitude" required="" class="layui-input">
					</div>
					<div class="layui-form-mid layui-word-aux">
						<a href="http://lbs.qq.com/tool/getpoint/index.html" style="color:#0079f4;" target="_blank">拾取当前经纬度</a>
					</div>
				</div>
				<div class="layui-form-item">
					<label for="phone" class="layui-form-label">
